...
public class GuiCombiner extends GuiContainer
{
    ...
    public GuiCombiner(InventoryPlayer par1InventoryPlayer, TileEntityCombiner par2TileEntityCombiner)
    {
        ...
        this.combinerInventory = par2TileEntityCombiner;
    }
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("container.combiner"), 60, 6, 4210752);
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/gui/combinerGui.png");
