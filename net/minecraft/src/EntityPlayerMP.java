...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    /**
     * Displays the electric furnace GUI for the passed in electric furnace entity. Args: tileEntityElectricFurnace
     */
    public void displayGUIElectricFurnace(TileEntityElectricFurnace par1TileEntityElectricFurnace)
    {
    	this.incrementWindowID();
    	this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 2, par1TileEntityElectricFurnace.getInvName(), par1TileEntityElectricFurnace.getSizeInventory()));
    	this.openContainer = new ContainerElectricFurnace(this.inventory, par1TileEntityElectricFurnace);
    	this.openContainer.windowId = this.currentWindowId;
    	this.openContainer.addCraftingToCrafters(this);
    }
