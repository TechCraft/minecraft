...
{
    private static final ElectricFurnaceRecipes smeltingBase = new ElectricFurnaceRecipes();
     ...
     */
    public static final ElectricFurnaceRecipes smelting()
    {
        return smeltingBase;
    }
    ...
    private ElectricFurnaceRecipes()
    {
        ...
        this.addSmelting(Item.steelIngot.itemdID, new ItemStack(Item.reinforcedIngot, 1.0F);
    }
