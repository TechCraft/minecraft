...
public class Item
{
    ...
    public static Item redCrystal = (new Item(170)).setIconCoord(2, 10).setItemName("redCrystal").setCreativeTab(CreativeTabs.tabMaterials);
    public static Item wand = (new ItemWand(170)).setIconCoord(1, 10).setItemName("wand").setCreativeTab(CreativeTabs.tabMisc);
